...
export function SiteHeader() {
  ...
  return (
    <>
      ...
      {/* Mobile Bottom Sheet — rendered via portal at document.body
          to escape the sticky header's stacking context which breaks
            ...
            {menu && (
              <div className="md:hidden">
                ...
                <motion.div
                  ...
                  className="fixed inset-x-0 bottom-0 z-[201] max-h-[90vh] overflow-y-auto rounded-t-[32px] bg-white px-6 pt-6 pb-8 text-[#181512] shadow-2xl"
                >
                  {/* Sheet Header */}
