    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-end">
      ...
      <div className="group relative flex items-center">
        ...
        <button
          ...
          className="flex h-12 w-12 items-center justify-center rounded-full bg-[#5e492e] text-white shadow-xl transition-all duration-300 hover:scale-110 hover:bg-[#3d2e1d] focus:outline-none cursor-pointer"
        >
      ...
      <div className="group relative flex items-center">
        ...
        <a
          ...
          className="flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition-all duration-300 hover:scale-110 hover:bg-[#20ba59] focus:outline-none"
        >
